...
/**
 * copy_info - clones the info to create
 * a new env or alias
...
/**
 * set_env - It puts the environment variable
 *
 * @name: The name of  environment variable
 * @value: Total value of environment variable
...
/**
 * _setenv - Variates the env variables names
 * With the name passed.
 * @datash:The  data relevant to env name and env value
 *
 ...
 *
 * @datash: Its the data relevant to env name
 *
 * Return: 1 upon success.
 */
